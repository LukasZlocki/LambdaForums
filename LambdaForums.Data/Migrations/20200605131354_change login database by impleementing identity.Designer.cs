...
namespace LambdaForums.Data.Migrations
{
    ...
    [Migration("20200605131354_change login database by impleementing identity")]
    partial class changelogindatabasebyimpleementingidentity
    {
            ...
            modelBuilder.Entity("LambdaForums.Data.Models.Post", b =>
                {
                    ...
                    b.HasOne("LambdaForums.Data.Models.ApplicationUser", "Users")
                        .WithMany()
